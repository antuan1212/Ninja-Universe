				...
				_1
					INSIDE
						Enter(atom/movable/M)
							if(M.bigatom_src) M=M.bigatom_src
							if(ismob(M))
								M.loc=locate(/turf/teleport/buildingteleports/Kiri_Hostpital/_1/OUTSIDE)
							.=..()
					OUTSIDE
						Enter(atom/movable/M)
							if(ismob(M))
								M.loc=locate(/turf/teleport/buildingteleports/Kiri_Hostpital/_1/INSIDE)
							.=..()
				_2
					INSIDE
						Enter(atom/movable/M)
							if(ismob(M))
								M.loc=locate(/turf/teleport/buildingteleports/Kiri_Hostpital/_2/OUTSIDE)
							.=..()
					OUTSIDE
						Enter(atom/movable/M)
							if(ismob(M))
								M.loc=locate(/turf/teleport/buildingteleports/Kiri_Hostpital/_2/INSIDE)
							.=..()
			Suna_Hostpital
				...
				_1
					INSIDE
						Enter(atom/movable/M)
							if(M.bigatom_src) M=M.bigatom_src
							if(ismob(M))
								M.loc=locate(/turf/teleport/buildingteleports/Suna_Hostpital/_1/OUTSIDE)
							.=..()
					OUTSIDE
						Enter(atom/movable/M)
							if(M.bigatom_src) M=M.bigatom_src
							if(ismob(M))
								M.loc=locate(/turf/teleport/buildingteleports/Suna_Hostpital/_1/INSIDE)
							.=..()
				_2
					INSIDE
						Enter(atom/movable/M)
							if(M.bigatom_src) M=M.bigatom_src
							if(ismob(M))
								M.loc=locate(/turf/teleport/buildingteleports/Suna_Hostpital/_2/OUTSIDE)
							.=..()
					OUTSIDE
						Enter(atom/movable/M)
							if(M.bigatom_src) M=M.bigatom_src
							if(ismob(M))
								M.loc=locate(/turf/teleport/buildingteleports/Suna_Hostpital/_2/INSIDE)
							.=..()
			Konoha_Hostpital
				...
				_1
					INSIDE
						Enter(atom/movable/M)
							if(M.bigatom_src) M=M.bigatom_src
							if(ismob(M))
								M.loc=locate(/turf/teleport/buildingteleports/Konoha_Hostpital/_1/OUTSIDE)
							.=..()
					OUTSIDE
						Enter(atom/movable/M)
							if(M.bigatom_src) M=M.bigatom_src
							if(ismob(M))
								M.loc=locate(/turf/teleport/buildingteleports/Konoha_Hostpital/_1/INSIDE)
							.=..()
				_2
					INSIDE
						Enter(atom/movable/M)
							if(M.bigatom_src) M=M.bigatom_src
							if(ismob(M))
								M.loc=locate(/turf/teleport/buildingteleports/Konoha_Hostpital/_2/OUTSIDE)
							.=..()
					OUTSIDE
						Enter(atom/movable/M)
							if(M.bigatom_src) M=M.bigatom_src
							if(ismob(M))
								M.loc=locate(/turf/teleport/buildingteleports/Konoha_Hostpital/_2/INSIDE)
							.=..()
			Kiri_Academy
